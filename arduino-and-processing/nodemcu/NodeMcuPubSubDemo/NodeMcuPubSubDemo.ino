...
char ssid[] = "DS9";     // your Wi-Fi SSID (name)
char pass[] = "henry64106";  // your Wi-Fi Encryption Key
...
const char* DEVICE_KEY     = "DKAKCKGFM5MZXT5XPT";   //your api key
char publishHBTopic[]   = "/v1/device/7827067617/heartbeat"; //device id here should be then same in your project
char publishHBPayload[] = "{\"pulse\":\"10000\"}";
char publishRawTopic[]   = "/v1/device/7827067617/rawdata"; //device id here should be then same in your project
char publishRawPayload[200];
char subscribeLedTopic[] = "/v1/device/7827067617/sensor/led/rawdata";  //sensor id here should be then same in your project
